...
from sqlalchemy import ForeignKey, DateTime, Integer, Enum, Text, UniqueConstraint
...
class AttemptAnswer(Base):
    ...
    task_id: Mapped[int] = mapped_column(ForeignKey("olympiad_tasks.id", ondelete="CASCADE"), index=True)
