...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Path to CSV file with recipient emails. Default: /app/emails_final.csv",
    )
    parser.add_argument(
        "--body",
        default=str(DEFAULT_BODY_FILE),
        help="Path to text/markdown file with email body. Default: /app/email_text.md",
    )
    parser.add_argument(
        "--subject",
    ...
    parser.add_argument(
        ...
        help="Directory for CSV report. Default: /app/reports",
    )
