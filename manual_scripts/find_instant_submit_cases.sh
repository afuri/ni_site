...
usage() {
  cat <<'USAGE'
Usage:
  ./manual_scripts/find_instant_submit_cases.sh [lookback_days] [submit_threshold_sec] [limit]
...
Examples:
  ./manual_scripts/find_instant_submit_cases.sh
  ./manual_scripts/find_instant_submit_cases.sh 30 3 1000
  DB_SERVICE=db ./manual_scripts/find_instant_submit_cases.sh 14 5 500
USAGE
}
