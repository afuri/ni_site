...
#
# Usage:
#   ./manual_scripts/export_attempts_summary_no_teachers_from_list.sh
#   ./manual_scripts/export_attempts_summary_no_teachers_from_list.sh ./reports/summary_no_teachers.csv
