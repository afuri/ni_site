...
#
# Examples:
#   ./manual_scripts/bulk_update_user_geo.sh --dry-run
#   ./manual_scripts/bulk_update_user_geo.sh --apply
#   ./manual_scripts/bulk_update_user_geo.sh --dry-run --delimiter ',' --csv ./user_geo.csv
