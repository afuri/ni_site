...
#
# Usage:
#   DRY_RUN=1 ./manual_scripts/regrade_task50_51_words.sh                  # preview only
#   ./manual_scripts/regrade_task50_51_words.sh                            # apply changes
#   REPORT_DIR=./reports ./manual_scripts/regrade_task50_51_words.sh       # custom report dir
