...
usage() {
  cat <<'USAGE'
Usage:
  ./manual_scripts/attempt_forensics.sh <user_id> [attempt_id]
...
Examples:
  ./manual_scripts/attempt_forensics.sh 123
  ./manual_scripts/attempt_forensics.sh 123 456
  DB_SERVICE=db PGUSER=postgres PGDATABASE=ni_site ./manual_scripts/attempt_forensics.sh 123
USAGE
}
