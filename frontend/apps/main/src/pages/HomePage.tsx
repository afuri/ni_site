...
const SCHEDULE_ITEMS = [
  ...
  { date: "01.04.2026", title: "Очный этап по математике" },
  { date: "02.04.2026", title: "Очный этап по информатике" },
];
            ...
            <div className="home-announcement-layout">
              <article className="home-announcement-card">
                <div className="home-announcement-body">
                  <h3>Уважаемые победители II отборочного тура!</h3>
                  <h2>Даты проведения очного тура:</h2>
                  <p>
                    •	Математика - 1 апреля 2026 года в 10:00
                  </p>
                  <p>
                    •	Информатика - 2 апреля 2026 года в 10:00
                  </p>
                  <p>Продолжительность очного тура по математике:</p>
                  <ul>
                    <li>1 класс – 60 минут </li>
                    <li>2–4 классы – 90 минут </li>
                    <li>5–7 классы – 120 минут</li>
                  </ul>
                  <p>Продолжительность очного тура по информатике: </p>
                  <ol>
                    <li>3–4 классы – 60 минут</li>
                    <li>5–7 классов – 90 минут</li>
                  </ol>
                  <p>
                    ППросим участников прибыть заблаговременно. Желаем удачи!
                  </p>
                </div>
              </article>
