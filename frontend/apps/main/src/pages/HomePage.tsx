            ...
            <div className="home-announcement-layout">
              <article className="home-announcement-card">
                <div className="home-announcement-body">
                  ...
                  <br></br>
                  <p>Результаты опубликованы в личных кабинетах участников.</p> 
                  <br></br>
                  <p><strong>Дипломы победителей и призёров, а также сертификаты участников <br></br> будут доступны не позднее 15 апреля.</strong></p>
                  <br></br>
